...
import (
	...
	jaegercfg "github.com/welcome112s/jaeger-client-go/config"
	jaegerlog "github.com/welcome112s/jaeger-client-go/log"
)
...
func ExampleConfiguration_InitGlobalTracer_testing() {
	...
	// and github.com/welcome112s/jaeger-lib/metrics respectively to bind to real logging and metrics
	// frameworks.
