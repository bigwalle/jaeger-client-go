...
import (
	...
	j "github.com/welcome112s/jaeger-client-go/thrift-gen/jaeger"
...
func BuildJaegerThrift(span *Span) *j.Span {
	...
	jaegerSpan := &j.Span{
		TraceIdLow:    int64(span.ContextV1.TraceID.Low),
		TraceIdHigh:   int64(span.ContextV1.TraceID.High),
		SpanId:        int64(span.ContextV1.SpanID),
		ParentSpanId:  int64(span.ContextV1.ParentID),
